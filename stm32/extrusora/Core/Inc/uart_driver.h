...
/* ========================================================= */
/* Declaracion de la estructura de HAL UART.                 */
/* ========================================================= */
...
#define UART_DRIVER_LINE_SIZE         128       // Tamaño máximo de una línea de texto recibida
#define UART_DRIVER_TX_LINE_SIZE      320       // Tamaño máximo de una línea de texto a transmitir (incluyendo terminadores)
#define UART_DRIVER_RX_QUEUE_LEN      8         // Cantidad de líneas que se pueden almacenar en la cola de recepción
#define UART_DRIVER_TX_QUEUE_LEN      8         // Cantidad de líneas que se pueden almacenar en la cola de transmisión
